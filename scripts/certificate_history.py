  ...
  <div id="performance-guide" hidden>
    <section class="performance-sheet cockpit-sheet" id="cockpit-sheet" aria-labelledby="guide-title">
      <header class="guide-header">
        <div><p class="eyebrow">Rating Performance Guide</p><h2 id="guide-title"><span id="yacht-name"></span> <small id="sail-number"></small></h2></div>
    ...
    <section class="performance-sheet polar-sheet" id="polar-sheet" aria-labelledby="polar-heading">
      <header class="guide-header"><div><p class="eyebrow">Rating Performance Guide</p><h2 id="polar-heading"><span id="polar-yacht-name"></span> <small id="polar-sail-number"></small></h2></div><div class="guide-meta"><span id="polar-certificate-ref"></span><span id="polar-issue-date"></span></div></header>
