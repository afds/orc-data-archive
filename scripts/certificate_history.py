...
<main class="performance-main">
  ...
  <div id="performance-guide" hidden>
    <section class="performance-sheet cockpit-sheet" id="cockpit-sheet" aria-labelledby="guide-title">
      ...
      <footer class="sheet-note">Theoretical ORC VPP rating targets. Actual performance varies with sea state, wind shear, crew execution, instrument calibration, sail selection, sail condition and Neptune’s goodwill.</footer>
    </section>
